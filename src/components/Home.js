            ...
            <div className="back">
              ...
              <div class="box title">
                    <div className="container-fluid solid">
                        <ul className="links">
                            <li onClick={()=>window.open("https://github.com/xenonreborn/algorithms_visualizer","_blank")}>
                                <i>
                                    <Github/>
                                </i>
                            </li>
                            <li onClick={()=>window.open("https://in.linkedin.com/in/sunyul-hossen-4811a4191","_blank")}>
                                <i>
                                    <LinkedIn/>
                                </i>
                            </li>
                ...
                <div>
                    ...
                    Currently these include Sorting, Pathfinding and ConvexHull Algorithms.
